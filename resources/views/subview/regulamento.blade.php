<div class="panel-group" id="col-regulamento" role="tablist" aria-multiselectable="true">
    <div class="panel panel-default">
        <div class="panel-heading" role="tab" id="regulamento-palpites">
            <h4 class="panel-title">
                <a role="button" data-toggle="collapse" data-parent="#col-regulamento" href="#item-regulamento-palpites" aria-expanded="true" aria-controls="item-regulamento-palpites">
                    Palpites
                </a>
            </h4>
        </div>
        <div id="item-regulamento-palpites" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="regulamento-palpites">
    ...
    <div class="panel panel-default">
        <div class="panel-heading" role="tab" id="regulamento-pontos">
            <h4 class="panel-title">
                <a class="collapsed" role="button" data-toggle="collapse" data-parent="#col-regulamento" href="#item-regulamento-pontos" aria-expanded="true" aria-controls="item-regulamento-pontos">
                    Pontuação
                </a>
            </h4>
        </div>
        <div id="item-regulamento-pontos" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="regulamento-pontos">
            <div class="panel-body">
                <dl class="lista-regulamento">
    ...
    <div class="panel panel-default">
        <div class="panel-heading" role="tab" id="regulamento-ranking">
            <h4 class="panel-title">
                <a role="button" data-toggle="collapse" data-parent="#col-regulamento" href="#item-regulamento-ranking" aria-expanded="true" aria-controls="item-regulamento-ranking">
                    Ranking
                </a>
            </h4>
        </div>
        <div id="item-regulamento-ranking" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="regulamento-ranking">
            <div class="panel-body">
                <dl class="lista-regulamento">
                    ...
                    <dt class="text-primary">Saída</dt>
                    <dd>Se o participante sair ou ser banido de um bolão o mesmo mantém sua pontuação estática, não será mais computado novos pontos, mas os pontos já adquiridos se manteram no histórico e será computado no ranking seguindo a regra de "Classificação Geral". Sendo assim, se o participante sair por vontade própria e rotar novamente ele terá a pontuação que tinha ao sair, mas a pontuação das partidas efetuadas enquanto esteve fora não serão computadas.</dd>
                </dl>
            </div>
        </div>
    </div>
