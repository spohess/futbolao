    ...
    <div class="row">
        <div class="col-xs-24 col-md-18 col-md-offset-3">
            <fieldset class="col-xs-24">
                ...
                <p>Existe um projeto para que haja gerenciamento financeiro onde não só o FutBolão lucre com isso, mas qualquer participante também, mas é preciso que os jogos sejam legalizados no país, enquanto isso o site continuará gerenciando somente pontuação e resultados.</p>
            </fieldset>
        </div>
        <div class="col-xs-24 col-md-18 col-md-offset-3">
